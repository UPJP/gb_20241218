...
//	@GetMapping("/")
	public String homeLoginV3(HttpServletRequest request, Model model) {
		...
		Member loginMember =(Member)session.getAttribute(SessionConst.LOGIN_MEMEB);
	...
	public String homeLoginV4(
			// session에서 attribute 뒤져서 loginMemeber값을 획득해서
			// loginMemeber라는 변수에 넣어준다.
			@SessionAttribute(name= SessionConst.LOGIN_MEMEB,required = false)Member loginMember,
			Model model 
			) {
