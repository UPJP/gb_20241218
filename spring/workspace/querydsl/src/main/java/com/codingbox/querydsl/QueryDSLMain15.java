...
public class QueryDSLMain15 {
   ...
   public static void main(String[] args) {
      ...
      try {  
         ...
         List<MemberDTO> result2 = queryFactory.select(Projections.bean(MemberDTO.class, 
         ...
         List<MemberDTO> result3 = queryFactory.select(Projections.fields(MemberDTO.class, 
        		 									member.username.as("name"), member.age))
        		 								.from(member)
        		 								.fetch();
         ...
         List<MemberDTO> result4 = queryFactory.select(Projections.constructor(MemberDTO.class, 
